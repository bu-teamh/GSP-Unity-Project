...
namespace GSP.States
{
	...
	public class UIScrapbookInventoryState : UIBaseState
	{
		//Constructor doesn't need touching.
		public UIScrapbookInventoryState(UIManager _object) : base(_object) { }

		//Constructor doesn't need touching.
		public UIScrapbookInventoryState(BaseState _state) : base(_state) { }
