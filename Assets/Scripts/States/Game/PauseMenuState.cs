...
namespace GSP.States
{
	...
	public class PauseMenuState : MenuBaseState
	{
		...
		public PauseMenuState(GameStateManager _object) : base(_object) { }

		//Second constructor doesn't need touching
		public PauseMenuState(BaseState _state) : base(_state) { }
		...
		{
			SetTransition(typeof(NormalGameplayState), EventArchetype.MenuInput, EventSubtype.TogglePause, EventFlag.KeyDown);
		}
		...
		protected override void Awake()
		{
			...
			SendEvent(EventPriority.Urgent, EventArchetype.UI, EventSubtype.Pause, EventFlag.Active);
		}
