...
namespace GSP.States
{
	...
	public class HealthGameplayState : NormalGameplayState
	{
		//Constructor doesn't need touching.
		public HealthGameplayState(GameStateManager _object) : base(_object) { }

		//Constructor doesn't need touching.
		public HealthGameplayState(BaseState _state) : base(_state) { }
		...
		public override void Update()
		{
			...
			if (
				m_thisObject.m_component.GetGlobalValue(GlobalValue.PlayerHealth) != 100 &&
				m_thisObject.m_component.GetGlobalValue(GlobalValue.InventoryHealth) > 0
				)
			{
				m_thisObject.m_component.AddToGlobalValue(GlobalValue.PlayerHealth, 50);
				m_thisObject.m_component.AddToGlobalValue(GlobalValue.InventoryHealth, -1);
			}
